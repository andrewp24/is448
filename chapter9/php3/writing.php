...
$filevar2 = fopen("/afs/umbc.edu/users/s/a/sampath/pub/text-files/names.txt", "a+") or die ("Error - could not open file");
if(!(file_exists("/afs/umbc.edu/users/s/a/sampath/pub/text-files/names.txt"))) 
